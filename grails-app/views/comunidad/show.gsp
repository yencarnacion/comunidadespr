...
<html>
    ...
    <body>
        ...
        <div id="show-comunidad" class="content scaffold-show" role="main">
            ...
            <f:display bean="comunidad" />
            <g:form resource="${this.comunidad}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.comunidad}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
